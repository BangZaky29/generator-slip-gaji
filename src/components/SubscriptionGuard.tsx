...
const CONFIG = {
    ...
    DEFAULT_FEATURE_SLUG: 'slip-gaji'
};
...
// =========================================
export const clearSubscriptionSession = (featureSlug: string = 'slip-gaji') => {
...
// =========================================
export const hasSubscriptionSession = (featureSlug: string = 'slip-gaji'): boolean => {
    try {
