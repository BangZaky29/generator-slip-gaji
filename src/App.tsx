...
function App() {
  ...
  return (
    <SubscriptionGuard featureSlug="slip-gaji">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex justify-end gap-3">
                    ...
                    <button
                      ...
                      className={`px-4 py-2 rounded-lg text-white font-medium transition-colors shadow-lg text-sm ${confirmModal.type === 'delete'
